  ...
  return (
    <div className="flex w-[85vw] shrink-0 snap-center flex-col gap-2 sm:w-72 md:w-64 lg:w-72">
      <div className="flex items-center justify-between px-1">
        <h2 className={cn('text-sm font-semibold', stage.isClosed ? 'text-muted-foreground' : 'text-foreground')}>
          {stage.name}
        </h2>
      ...
      <div
        ...
        className={cn(
          ...
          stage.isClosed ? 'border-border/60 bg-muted/60' : 'border-border bg-muted/30',
